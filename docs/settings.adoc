...
////
Known Color Names for 'Role'
Aqua, Black, Blue, Fuchsia, Gray, Green, Lime, Maroon,
Navy, Olive, Purple, Red, Silver, Teal, White, Yellow
////

:icon-prompt:           icon:terminal[role=red]
:icon-welcome:          icon:heart[role=red]
:icon-update-project:   icon:arrow-circle-o-down[role=red]
:icon-dir:              icon:folder[role=yellow]
:icon-dir-src:          icon:folder[role=aqua]
:icon-dir-test:         icon:folder[role=lime]
:icon-dir-package:      icon:folder[role=silver]
:icon-dir-target:       icon:folder[role=red]
...
:icon-module:           icon:cube[role=green]
:icon-one:
:icon-question:         icon:question-circle[role=blue]
:symbol-update-project: pass:n[[blue]#*&#x2199;*#]
:q:                     pass:n[[big]#icon:question-circle[role=green]#]
:a:                     pass:n[[big]#icon:flask[role=blue]#]

:docnav: pass:n[[ <<about_classes,Inhalt>> | <<demos_classes,Demo>> | <<exercises_classes,Übungen>> ]]

:prompt:               pass:n[[red]#KI Prompt# {icon-prompt}]
