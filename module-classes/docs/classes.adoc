...
Erzeuge eine oder beide Klassen mithilfe einer KI (GenAI). Wie muss der Prompt formuliert werden, gibt es Besonderheiten zu beachten? Vergleiche die KI-Implementierung mit der manuell implementierten Klasse.

NOTE: _Zusatzfrage: Fällt bei den Implementierungen aus der Übung etwas besonders auf?_
