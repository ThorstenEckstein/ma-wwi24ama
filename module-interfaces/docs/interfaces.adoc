...
In Java gibt es neben konkreten Klassen auch *abstrakte Datentypen*. Sie enthalten auch eine Sammlung von Attributen und Methoden, diese können aber konkret oder abstrakt sein.

Die "Abstraktion" ist eines der wichtigsten *Kernkonzepte* in Java und wird vor allem eingesetzt, um verschiedene Dinge umzusetzen. Dazu gehören u.a.

* Wiederverwendbarkeit,
* Polymorphism oder
* Mehrfach-Vererbung

Man kann sagen, eine abstrakte Klasse sei eine Art *Hybrid* zwischen

. einer *konkreten* _Klasse_ auf der einen Seite und
. einem *abstrakten* _Interface_ auf der anderen (siehe nächstes Kapitel).
...
[[about_interfaces]]
In Java ist ein *Interface* ein abstrakter Datentyp, der einer Sammlung von Methoden und/oder Konstanten enthält. Dies ist eines der wichtigsten *Kernkonzepte* in Java und wird vor allem eingesetzt, um Abstraktion, Polymorphism und Mehrfach-Vererbung in der Programmiersprache zur Verfügung zu stellen.

Ein Interface dient als eine Art

[subs=normal]
 *Vertrag* bzw. *Vorschrift*
