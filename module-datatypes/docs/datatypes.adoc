...
Komplexe Datentypen in Java sind Datentypen, die sich auf Objekte beziehen und in Form von Klassen implementiert werden. Im Gegensatz zu primitiven Datentypen sind sie nicht vordefiniert, sondern werden von Menschen implementiert.
...
Sie dienen als Vorlage für Objekte und enthalten verschiedene Komponenten wie Namen, Attribute, Modifikatoren und Methoden.
...
----
int i = 42;
Integer j = 42; // Erzeugt ein Objekt des Wrappers 'Integer'
----
