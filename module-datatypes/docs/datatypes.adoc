...
Klassen::
Dienen als Vorlage für Objekte und enthalten verschiedene Komponenten wie Namen, Modifikatoren und Methoden.

Strings (und Variationen)::
...
Objekte::
Sind Instanzen (Werte) von Klassen, sie können z.B. über  Methoden miteinander interagieren.
