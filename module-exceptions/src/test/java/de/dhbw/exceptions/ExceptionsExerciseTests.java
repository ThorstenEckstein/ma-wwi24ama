...
public class ExceptionsExerciseTests {
    ...
    @DisplayName("""
        ...
        2. Implementiere dazu auch eine neue konkrete, eigene 'Exception' (CheckedException), die von Exception
           abgeleitet werden soll und von 'execute()' geworfen werden kann.
