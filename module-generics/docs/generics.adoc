...
_Optional: Realisiere auch einen konkreten Taschenrechner und schreibe dazu einen kleinen Test, der die
Funktionsfähigkeit mindestens einer der Rechenarten mit Beispielwerten testet._
