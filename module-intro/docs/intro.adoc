...
.. `Clone Repository`, in älteren Versionen `Get from VCS` anklicken (VCS = Version Control System, `Git`)  image:images/intellij-clone-repository.png[align="center", width="23%"] oder image:images/intellij-start-get-from-vcs.png[align="center"]
